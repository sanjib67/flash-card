          ...
          <div className='card'>
            ...
            <div
              ...
              <div className='card-body'>
                ...
                automatically get installed on to your system. Then by clicking
                on the shortcut key for Flashcard present on the desktop or
                going to start menu click on Programs and then click on the
                Flashcard icon
              </div>
            </div>
          </div>
            ...
            <div className='card-header' id='faq-2'>
              <h2 className='mb-0'>
                <button
                  ...
                  When I open the Flashcard I see “Data access error, please try
                  again or contact support team” message.
                </button>
              </h2>
            </div>
            <div
            ...
            <div className='card-header' id='faq-5'>
              <h2 className='mb-0'>
                <button
                  ...
                  but still cannot access the latest data that has been uploaded
                  or shared with Sinergi team.
                </button>
              </h2>
            </div>
            <div
            ...
            <div className='card-header' id='faq-8'>
              <h2 className='mb-0'>
                <button
                  ...
                  If I am not connected to the SANOFI network and I want to see
                  the reports how can I access it?
                </button>
              </h2>
            </div>
            <div
